...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Admin - Vegetability Website</title>
	...
	<link rel="stylesheet" type="text/css" href="../assets/admin/vendors/styles/bootstrap.min.css">
...
<!--							</a>-->
		...
		<div class="header-right">
			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					<a class="dropdown-toggle dropdown-toggle2" href="#" role="button" data-toggle="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						...
						<a class="dropdown-item" href="index.php?controller=login&action=logout"><i class="dw dw-logout"></i> Log Out</a>
					</div>
				</div>
			</div>
			<div class="github-link">
				<a href="https://github.com/dropways/deskapp" target="_blank"><img src="../assets/admin/vendors/images/github.svg" alt=""></a>
			</div>
		</div>
	</div>
	...
	<div class="left-side-bar">
		<div class="brand-logo">
			<a href="index.php">
				<!-- <img src="../assets/admin/vendors/images/lg.svg" alt="" style="width: 100%; height:100%;"> -->
				<img src="../assets/admin/vendors/images/spe-01.png" alt="">
			</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="index.php?controller=categories" class="dropdown-toggle">
							<span class="micon dw dw-edit2"></span><span class="mtext">Categories</span>
						</a>
					</li>
					<li class="dropdown">
						<a href="index.php?controller=products" class="dropdown-toggle">
							<span class="micon dw dw-library"></span><span class="mtext">Products</span>
						</a>
					</li>
					<li>
						<a href="index.php?controller=users" class="dropdown-toggle no-arrow">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-copy"></span><span class="mtext">Others</span>
						</a>
						<ul class="submenu">
							<li><a href="index.php?controller=orders">Orders</a></li>
						</ul>
					</li>
				</ul>
			</div>
